        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center p-6 border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition duration-200">
            ...
            <p className="text-gray-600">
              Create an account as a donor or recipient with your blood type and location information
            </p>
          </div>
          ...
          <div className="text-center p-6 border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition duration-200">
            ...
            <p className="text-gray-600">
              Find donors or blood requests near your location based on blood type compatibility
            </p>
          </div>
