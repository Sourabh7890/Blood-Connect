...
CREATE POLICY "Users can read all donor profiles" ON users
  FOR SELECT USING (role = 'donor' AND status = 'active');
...
CREATE POLICY "Donors can read active requests" ON blood_requests
